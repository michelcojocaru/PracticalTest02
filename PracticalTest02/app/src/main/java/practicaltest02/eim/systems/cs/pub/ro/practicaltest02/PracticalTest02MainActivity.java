...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clientAddressEditText = (EditText)findViewById(R.id.adressClient);
        ...
        getWeatherForecastButton = (Button)findViewById(R.id.getForecast);
        getWeatherForecastButton.setOnClickListener(getWeatherForecastButtonClickListener);
        weatherForecastTextView = (TextView)findViewById(R.id.weatherTextView);
    }
